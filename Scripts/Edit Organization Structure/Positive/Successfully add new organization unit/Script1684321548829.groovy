...
WebUI.setText(findTestObject('Page_OrangeHRM/input_Name_oxd-input oxd-input--focus'), 'Test Unit')

WebUI.click(findTestObject('Object Repository/Page_OrangeHRM/button_Save'))

WebUI.verifyElementVisible(findTestObject('Object Repository/Page_OrangeHRM/div_SuccessSuccessfully Saved'))

WebUI.scrollToElement(findTestObject('Page_OrangeHRM/div_Test Unit'), 0)

WebUI.verifyElementVisible(findTestObject('Page_OrangeHRM/div_Test Unit'), FailureHandling.STOP_ON_FAILURE)
