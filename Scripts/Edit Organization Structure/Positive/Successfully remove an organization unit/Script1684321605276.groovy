...
WebUI.click(findTestObject('Page_OrangeHRM/button_OrganizationUnitRow1_oxd-icon-button org-action-icon'))

WebUI.click(findTestObject('Page_OrangeHRM/button_Yes, Delete'))

WebUI.verifyElementVisible(findTestObject('Page_OrangeHRM/div_SuccessSuccessfully Deleted'), FailureHandling.STOP_ON_FAILURE)
