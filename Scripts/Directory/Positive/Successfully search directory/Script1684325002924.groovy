...
'name is derived from Test Case Variable'
WebUI.setText(findTestObject('Page_OrangeHRM/input'), name)
...
WebUI.verifyElementVisible(findTestObject('Page_OrangeHRM/p_employeeName', [('nameParam') : name]))
